...
#define LOCK_INIT()     sem_init(&PollLock, 0, 1)
#define LOCK_WAIT()     sem_wait(&PollLock)
#define LOCK_TRY_WAIT() (sem_trywait(&PollLock) == 0)
#define LOCK_RELEASE()  sem_post(&PollLock)
#define LOCK_DESTROY()  sem_destroy(&PollLock)
